...
def render_app_header():
    ...
    logo_html = (
        f'<img src="{logo_uri}" alt="BTG">'
        if logo_uri
        else '<strong>BTG</strong>'
    )
    ...
    <div class="audit-hero audit-brand-hero">
        ...
        <div class="audit-logo-lockup">
            {logo_html}
            <div class="brand-name">BTG Audit System {APP_VERSION}</div>
...
if st.session_state.generation_state == "preparing":
    ...
    st.info(f"⚙️ `[СИСТЕМА]`: Инициализация аналитического ядра BTG Consulting {APP_VERSION}...")
...
if st.session_state.generation_state == "finalized":
    ...
    st.success("🎉 Экспертная презентация сформирована и проверена системой контроля качества BTG Consulting!")
...
st.info(f"BTG Audit System {APP_VERSION} | by Ivan Rudoy | Алматы 2026")
